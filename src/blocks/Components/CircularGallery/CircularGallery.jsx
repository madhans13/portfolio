...
class Media {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          ...
          // ✅ FIX: Use the texture's own alpha channel to remove black squares.
          gl_FragColor = color;
        }
      `,
      uniforms: {
  ...
  createTitle() {
    this.title = new Title({
      ...
      // ✅ FIX: Changed incorrect 'fontFamily' prop to 'font'.
      font: this.font,
    });
  }
  update(scroll, direction) {
    ...
    if (this.bend === 0) {
      this.plane.position.y = this.viewport.height / 2 - this.plane.scale.y / 2 - 0.2;
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y =
      (this.viewport.height * (280 * this.scale)) / this.screen.height;
    this.plane.scale.x =
      (this.viewport.width * (280 * this.scale)) / this.screen.width;
